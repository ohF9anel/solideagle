...
//
            ...
            $conn->write("setacl -ot file -actn ace -ace \"n:" . AD_NETBIOS . "\\Domain Admins;s:n;p:full;i:sc,so\" -on " . $path . "\\" . $username . "\\" . DIR_NAME_DOWNLOADS. "\n");
            // protection folder
            ...
            //$conn->write("setacl -ot file -actn ace -ace \"n:" . AD_NETBIOS . "\\" . $username . ";s:n;m:deny;p:FILE_READ_ATTRIBUTES;i:np\" -on " . $path . "\\" . $username . "\\" . DIR_NAME_DOWNLOADS . "\n");
