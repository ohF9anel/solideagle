...
var ExcuseList = Array(
		...
		"It's those computer people in India.  They keep stuffing things up.",
		...
		"Linux",
		"POSIX",
		"\ or /?  Use the other slash.  No, the other one.  No, the other one.",
		"Press the Any key to continue", "mouse not properly calibrated",
		"Change the wallpaper.  Immediately!", "Daemon monkeys");
