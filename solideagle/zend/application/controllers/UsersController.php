...
function groupsToJson($roots,$isfirst = true)
{
	...
	{
		$arr = array("data" => array("title" => $group->getName(), "attr" => array("href" => "javascript:void(0)")), "attr" => array("id" => "tree" . l$group->getId(),"groupid" => $group->getId(),"groupname" => $group->getName()));
